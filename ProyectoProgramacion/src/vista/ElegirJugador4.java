...
public class ElegirJugador4 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ElegirJugador4 frame = new ElegirJugador4();
	...
	public ElegirJugador4() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new vista.Delanteros4().setVisible(true);
				dispose();
			}
		});
		...
		btnNewButton_5.setBounds(359, 116, 227, 99);
