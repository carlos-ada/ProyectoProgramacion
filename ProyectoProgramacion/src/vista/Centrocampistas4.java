...
public class Centrocampistas4 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Centrocampistas4 frame = new Centrocampistas4();
	...
	public Centrocampistas4() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "SELECT * FROM barcelona WHERE Jugadores4 IN ('Rakitic','Arthur','Vidal','De Jong') ";
		...
		btnNewButton.setBounds(26, 167, 174, 100);
		...
		btnNewButton_2.setBounds(440, 150, 224, 79);
