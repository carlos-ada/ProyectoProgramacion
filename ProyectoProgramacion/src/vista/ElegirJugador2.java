...
public class ElegirJugador2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ElegirJugador2 frame = new ElegirJugador2();
	...
	public ElegirJugador2() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new vista.Delanteros2().setVisible(true);
				dispose();
			}
		});
		...
		btnNewButton_5.setBounds(360, 110, 227, 99);
