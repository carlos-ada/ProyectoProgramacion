...
public class Delanteros1 extends JFrame {
	...
	public Delanteros1() {
		...
		btnNewButton_2.setBounds(231, 265, 150, 35);
		...
		lblDelanteros.setBounds(280, -2, 243, 25);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "SELECT * FROM jugadores WHERE Jugadores IN ('Loren Moron','Borja Iglesias') ";
		...
		btnNewButton.setBounds(27, 142, 174, 100);
		...
		btnNewButton_2_1.setBounds(440, 112, 224, 79);
		contentPane.add(btnNewButton_2_1);
		
		JButton btnNewButton_3 = new JButton("Quitar Jugador");
		btnNewButton_3.setFont(new Font("Tahoma", Font.PLAIN, 15));
		btnNewButton_3.setBounds(441, 217, 223, 79);
