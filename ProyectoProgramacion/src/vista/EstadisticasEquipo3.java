...
public class EstadisticasEquipo3 extends JFrame {
	...
	public EstadisticasEquipo3() {
		...
		JLabel lblEstadisticasEquipo = new JLabel("Estadisticas Real Madrid");
		lblEstadisticasEquipo.setForeground(Color.GREEN);
		lblEstadisticasEquipo.setFont(new Font("Tahoma", Font.BOLD, 20));
		lblEstadisticasEquipo.setBounds(215, 0, 283, 25);
		...
		btnNewButton_2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "SELECT * FROM equipos WHERE Equipos = 'Real Madrid' ";
		...
		btnNewButton_2.setBounds(26, 127, 174, 100);
		...
		icon = new ImageIcon(Login.class.getResource("/vista/bernabeu.jpg"));
        image = icon.getImage();
