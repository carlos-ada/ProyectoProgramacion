...
public class EstadisticasEquipo4 extends JFrame {
	...
	public EstadisticasEquipo4() {
		...
		JLabel lblEstadisticasEquipo = new JLabel("Estadisticas Equipo 4");
		lblEstadisticasEquipo.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblEstadisticasEquipo.setBounds(108, 0, 243, 25);
		contentPane.add(lblEstadisticasEquipo);
		
		table = new JTable();
		table.setBounds(33, 36, 354, 168);
		...
		btnNewButton.setBounds(136, 215, 134, 35);
