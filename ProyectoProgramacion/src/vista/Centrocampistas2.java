...
public class Centrocampistas2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Centrocampistas2 frame = new Centrocampistas2();
	...
	public Centrocampistas2() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "SELECT * FROM sevilla WHERE Jugadores2 IN ('Suso','Fernando','Banega','Ocampos') ";
