...
public class Defensas3 extends JFrame {
	...
	public Defensas3() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "SELECT * FROM madrid WHERE Jugadores3 IN ('Marcelo','Sergio Ramos','Varane','Carvajal') ";
