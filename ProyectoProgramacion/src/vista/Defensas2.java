...
public class Defensas2 extends JFrame {
	...
	public Defensas2() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "SELECT * FROM sevilla WHERE Jugadores2 IN ('Reguilon','Diego Carlos','Jesus Navas','Escudero') ";
		...
		btnNewButton.setBounds(27, 183, 174, 100);
